...
public class MapFragment extends Fragment implements OnMapReadyCallback, BusStopViewInterface {
    ...
    private CountDownTimer countDownTimer; //timer for the refresh button
    ...
    private LatLng defaultLocation = new LatLng(49.890800, -97.130737); //if user does not have default location on, lead them to the Forks!
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        busStopListView = rootView.findViewById(R.id.MapRecyclerView);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        //Constrain the camera location and zoom wise
