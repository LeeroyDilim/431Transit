...
public class ArrivalInstanceView {
    ...
    public ArrivalInstanceView(String busBadge, BadgeStyle badgeStyle, String busName, LocalDateTime busExpectedTime, LocalDateTime busActualTime, boolean isCancelled) {
